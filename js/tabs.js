$(document).ready(function(){
  ...
  data.tabs.map((tab, i)=>{
    ...
    $("#myTab").append('<li class="nav-item">'+
        '<a class="nav-link '+activeClass+'" id="home-tab" data-toggle="tab" href="#tab'+i+'" role="tab" aria-controls="home" aria-selected="true">'+tab.name+'</a></li>')
tab.foodList.map((food, i)=>{
  foodList += '<div class="cont"><div class="name">'+food.name+'</div><img src="'+food.img+'"></div>'
});
